...
def mostrar_datos(titulo, mostrar_contenedor, formulario="",contador=1,salir = "", elegir_opcion=""):
...
def mostrar_datos_matriz(titulo, matriz, formulario="",contador=1,salir = "", elegir_opcion=""):
    establecer_titulo(titulo)
...
def consultar_tareas():
    formulario_tarea = ["Nombre: ", "Estado: ", "Prioridad: ",
                   "Responsable: ", "Descripción:" ]
    if tareas:
        tarea = mostrar_datos_matriz(titulo="Tareas en general", matriz=tareas, elegir_opcion="Seleccionar una tarea:")
