...
printf " - %s\n" "${PAQUETES_ELEGIDOS[@]}"
gum spin --title="Instalando paquetes..." -- \
...
echo "sa"
#sudo pacman -S --needed "${PAQUETES_ELEGIDOS[@]}"
...
gum style --border normal --margin "1" --padding "1 2" --border-foreground 212 "Hypr$(gum style --foreground 212 'crow')"
