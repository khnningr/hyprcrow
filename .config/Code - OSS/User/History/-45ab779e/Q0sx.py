...
def mostrar_datos(titulo, mostras_contenedor, formulario="",contador=1,salir = "", pregunta="", matriz="N"):
    ...
    for i in range(len(mostras_contenedor)):
        ...
        elif matriz == "S" and contador >= 1:
            print(mostrar_datos[i])
            print(mostrar_datos[i][0])
...
def consultar_tareas():
    formulario_tarea = ["Nombre: ", "Estado: ", "Prioridad: ",
                   "Responsable: ", "Descripción:" ]
    if tareas:
        mostrar_datos(titulo="Tareas en general", mostras_contenedor=tareas, matriz="S")
