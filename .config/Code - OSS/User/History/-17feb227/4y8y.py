...
class GestorTareas(Tarea):
    ...
    def definir_prioridad(
        self, priodidad_tarea = "", # Puedes pasar como parametro, el prioridad de la tarea directamente; para inicializar tareas.
        ):
        # Condición que verifica si la tarea debe iniciarse junto con el programa.
        if prioridad_tarea:
        ...
        self.iterador_unidimencional(prioridades_disponibles)
        # Variable auxiliar que guarda el dato anterior.
        ...
        prioridad_tarea = input ("\nIngrese el prioridad de la tarea: ").capitalize() # Uso de capitalize() para dar formato.
